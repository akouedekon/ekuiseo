...
class BookingServicePricingTest {
    ...
    void setUp() {
        ...
        service = new BookingService(bookingRepository, tripRepository, tripStopRepository,
                userRepository, subscriptions, mock(MessageRepository.class), mock(bj.ekuiseo.api.repository.ReviewRepository.class), mock(bj.ekuiseo.api.repository.ReportRepository.class), mock(BookingMapper.class),
                new CancellationPolicy(), new DriverCancellationPolicy(), mock(NotificationService.class),
                mock(PaymentService.class), mock(AuditService.class), new FeePolicy(0.08, 5, 1000), new DriverApprovalPolicy(24), 20, 24);
    }
