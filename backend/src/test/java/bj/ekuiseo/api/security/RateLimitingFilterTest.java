...
class RateLimitingFilterTest {
    ...
    void publicSearch_isLimitedPerIp_andThe429CarriesRetryAfter() throws Exception {
        ...
        RateLimitingFilter filter = new RateLimitingFilter(null, 100, 60, 120, 60, 10, 600, 2, 60, 30, 600, 10, 600, 30, 600, 120, 60, 120, 60);
        FilterChain chain = mock(FilterChain.class);
        for (int i = 0; i < 2; i++) {
            MockHttpServletResponse res = new MockHttpServletResponse();
    ...
    void messages_areLimitedPerAuthenticatedUser_notPerIp() throws Exception {
        ...
        RateLimitingFilter filter = new RateLimitingFilter(jwt, 100, 60, 120, 60, 10, 600, 60, 60, 1, 600, 10, 600, 30, 600, 120, 60, 120, 60);
        FilterChain chain = mock(FilterChain.class);
